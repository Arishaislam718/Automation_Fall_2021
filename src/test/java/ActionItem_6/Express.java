...
public class Express {
    ...
    public void ExpressSearchDataDriven() throws BiffException, IOException, WriteException, InterruptedException {
        ...
        Workbook readableFile = Workbook.getWorkbook(new File("src/main/resources/ExpressSearch.xls"));
        ...
        WritableWorkbook writableFile = Workbook.createWorkbook(new File("src/main/resources/ExpressSearch_Results.xls"), readableFile);
       ...
       for(int i = 1; i < rowCount2;i++) {
          ...
          // Reusable_Actions_Loggers.sendKeysMethod(driver,"//*[@class='rvndd--shipping.state--6']",state,logger,"state");
           ...
           Label label = new Label(1,i,result);
