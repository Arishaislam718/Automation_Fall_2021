...
public class Google_Array_Test {
    public static void main(String[] args) throws InterruptedException {
        ...
        for(int i = 0; i< cities.length; i++){
            ...
            System.out.println("My search result for city  " + cities[i] + " is " + arrayResult[1]);
        }// end of for loop
        //quit will be defined outside of for loop because you are quitting only once at the end
        driver.quit();
    }// end of main method
}// end of java class
